...
export class UserService {
  ...
  register(data:any){
   ...
   return this.httpservice.postService("https://localhost:44322/api/User/Register", data, false, header)
  }
  login(data:any){
    let header = {
      headers:new HttpHeaders({
   ...
   return this.httpservice.postService("https://localhost:44322/api/User/login", data, false, header)
  }
  forget(data:any){
    let header = {
      headers:new HttpHeaders({
